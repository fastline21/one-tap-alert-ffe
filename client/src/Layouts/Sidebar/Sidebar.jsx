...
const Sidebar = () => {
  ...
  return (
    <Navbar.Collapse className="col-md-3 col-lg-2 d-lg-block sidebar">
      <div className="position-sticky pt-3 sidebar-sticky">
        <Nav className="flex-column" variant="pills">
          <Nav.Item>
            <Nav.Link as={Link} to="/" className={page === '/' ? 'active' : ''}>
              <svg
          ...
          <Nav.Item>
            <Nav.Link
              as={Link}
              to="/emergencies"
              className={page === '/emergencies' ? 'active' : ''}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
          ...
          {/* <Nav.Item>
            <Nav.Link
              as={Link}
              to="/user-types"
              className={page === '/user-types' ? 'active' : ''}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
          ...
          <Nav.Item>
            <Nav.Link
              as={Link}
              to="/emergency-types"
              className={page === '/emergency-types' ? 'active' : ''}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
          ...
          <Nav.Item>
            <Nav.Link
              as={Link}
              to="/emergency-statuses"
              className={page === '/emergency-statuses' ? 'active' : ''}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
          ...
          <Nav.Item>
            <Nav.Link
              as={Link}
              to="/emergency-categories"
              className={page === '/emergency-categories' ? 'active' : ''}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
          ...
          <Nav.Item>
            <Nav.Link
              as={Link}
              to="/barangays"
              className={page === '/barangays' ? 'active' : ''}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
